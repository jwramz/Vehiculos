...
namespace AIVA.AccesoDatos.Migrations
{
    ...
    [Migration("20211224184832_actualizacionTablaVehiculosOficina")]
    partial class actualizacionTablaVehiculosOficina
    {
            ...
            modelBuilder.Entity("AIVA.Modelos.Models.Vehiculo", b =>
                {
                    ...
                    b.HasOne("AIVA.Modelos.Models.Comprador", "Comprador")
                        .WithMany()
                    ...
                    b.HasOne("AIVA.Modelos.Models.Vendedor", "Vendedor")
                        .WithMany()
